      ...
      <div class="row row-lg">
        ...
        <div class="col-sm-12 col-md-6">
          ...
          <div class="example-wrap">
            ...
            <div class="example">
              <form class="form-horizontal" action="<?php echo base_url('user/edit_action/'.$data->id_user);?>" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <select name="id_group" class="form-control" required>
                      ...
                      ?>
                        <option value="<?php echo $value->id_group; ?>" alue="<?php echo $value->id_group == $data->id_group ? 'selected' : '' ?>"><?php echo $value->name_group; ?></option>
                      <?php
                        }
                      ?>
                    </select>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" autocomplete="off" placeholder="Name User" required name="name_user" class="form-control" value="<?php echo $data->name_user?>">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" autocomplete="off" placeholder="Username" required name="username" class="form-control" value="<?php echo $data->username?>">
                  </div>
                </div>
