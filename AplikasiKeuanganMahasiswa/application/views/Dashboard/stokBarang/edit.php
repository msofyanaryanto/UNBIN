      ...
      <div class="row">
        ...
        <div class="col-sm-6 col-md-6">
          ...
          <div class="example-wrap">
            ...
            <div class="example">
              <form class="form-horizontal" action="<?php echo base_url($linkTo);?>/update_action/<?= $data->id_barang ?>" method="post">
                <div class="form-group">
                  <label class="col-sm-4 control-label">Barang ID : </label>
                  <div class="col-sm-6">
                    <input type="text" autocomplete="off" placeholder="BRG0001" id='id_barang'
                     onkeyup="search()" required name="barangID" class="form-control"  value=<?= $data->kode_barang ?> disabled>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <select name="kategoriID" class="form-control" id="id_kategori" disabled>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" disabled autocomplete="off" placeholder="Nama Barang" id="nama_barang" required name="namaBarang" class="form-control" value=<?= $data->nama_barang ?>>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text"  disabled autocomplete="off" placeholder="Jumlah" required name="jumlah" class="form-control" value=<?= $data->stok ?>>
                   </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" disabled autocomplete="off" placeholder="Harga Beli" required name="hargaBeli" id="harga_beli" class="form-control"  value=<?= $data->harga_beli ?>>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" disabled autocomplete="off" placeholder="Harga Jual" required name="hargaJual" id="harga_jual" class="form-control" value=<?= $data->harga_jual ?>>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" autocomplete="off" placeholder="Stok Minimal" required name="stokMinimal" class="form-control" value=<?= $data->stok_minimal ?>>
                   </div>
                </div>
