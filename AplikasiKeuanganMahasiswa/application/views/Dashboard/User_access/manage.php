<div class="page-header">
  <h1 class="page-title">Manage User Access</h1>
  <ol class="breadcrumb">
    <li><a href="<?php echo base_url();?>">Dashboard</a></li>
    <li><a href="<?php echo base_url('group');?>">Group Management</a></li>
    <li class="active">Manage user access</li>
  </ol>
        ...
        <div class="col-sm-12 col-md-12">
          ...
          <div class="table-responsive">
                <table class="table table-bordered" style="border-collapse: inherit;">
                  <thead>
                    <tr class="active">
                     <th width="500px" style="vertical-align:middle;">Name Module</th>
                     <th width="50px" style="vertical-align:middle; text-align:center;">Akses</th>
                     <th width="50px" style="vertical-align:middle; text-align:center;">Add</th>
                     <th width="50px" style="vertical-align:middle; text-align:center;">View</th>
                     <th width="50px" style="vertical-align:middle; text-align:center;">Edit</th>
                     <th width="50px" style="vertical-align:middle; text-align:center;">Delete</th>
