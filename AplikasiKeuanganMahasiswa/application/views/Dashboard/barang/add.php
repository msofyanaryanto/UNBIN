            ...
            <div class="example">
              <form class="form-horizontal" action="<?php echo base_url($linkTo);?>/add_action" method="post">
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" autocomplete="off" placeholder="BRG0001" id='id_barang' onkeyup="search()" required name="barangID" class="form-control" >
                  </div>
                  <div class="col-sm-2">
                  ...
                  <div class="col-sm-8">
                    <select name="kategoriID" class="form-control" id="id_kategori">
                        ...
                        foreach($kategori as $valueK){ ?>
                          <option value="<?= $valueK->id_kategori ?>"><?= $valueK->kategori ?></option>
                        <?php } ?>
                    </select>
                  </div>
                </div>
                    ...
                    <select name="supplierID" class="form-control" id="id_supplier">
                        ...
                        <?php 
                          foreach($supplier as $valueS){ ?>
                            <option value="<?= $valueS->id_supplier ?>"><?= $valueS->nama_supplier ?></option>
                        <?php } ?>
                    </select>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" autocomplete="off" placeholder="Nama Barang" id="nama_barang" required name="namaBarang" class="form-control" >
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" autocomplete="off" placeholder="Harga Beli" required name="hargaBeli" id="harga_beli" class="form-control" >
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" autocomplete="off" placeholder="Harga Jual" required name="hargaJual" id="harga_jual" class="form-control" >
                  </div>
                </div>
