    ...
    <div class="navbar-header">
     ...
     <!--  <button type="button" class="navbar-toggle collapsed" data-target="#site-navbar-collapse"
      ...
      <div class="navbar-brand navbar-brand-center site-gridmenu-toggle" data-toggle="gridmenu">
        <!--<img class="navbar-brand-logo" src="<?php echo base_url(); ?>assets/global/assets/images/logo_ap.png" title="Remark">-->
        <span class="navbar-brand-text hidden-xs">Kasir</span>
      </div>
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu" role="menu">
              ...
              <li role="presentation">
                <a href="<?php echo base_url()?>dashboard/get_logout" role="menuitem"><i class="icon wb-power" aria-hidden="true"></i> Logout</a>
              </li>
            </ul>
          </li>
        </ul>
